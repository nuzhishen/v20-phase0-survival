...
- 新账号第一次接手时，先读 `AGENTS.md`、本文件、`docs\migration_manifest.md` 和 Day 2 交接总结。
...
| 默认分支 | `main` |
| 最近已知 Day 3 提交 | `6871f4cab606ae2ba79582c49784e748c11c5167` |
| 提交说明 | `phase0-day3 manual react state machine` |
...
9. `day03_react_loop\docs\day03-what-blocked.md`
10. `docs\phase0_daily_log.md`
11. `docs\phase0_final_review.md`
...
Day 1、Day 2、Day 3 都存在顶层 `app` 包名，测试必须在各自目录的独立进程中运行，不要直接从仓库根目录混跑 pytest。
...
```text
请先读取本仓库的 AGENTS.md、README.md、docs/account_switch_handoff.md、docs/migration_manifest.md、docs/day03_to_day04_handoff.md、day02_llm_budget/docs/day02_handoff_summary.md、day03_react_loop/docs/react_accuracy_report.md 和 day03_react_loop/docs/day03-what-blocked.md，作为当前上下文。继续开发时严格遵守 Phase 0 边界：不用 WebSocket、LangGraph、MCP、Redis、前端或平台化服务；Day 4 只做最小 RAG 链路。
```

## 当前接续结论

本项目已经把 Day 1 和 Day 2 的源码、测试、文档与交接信息迁入 `v20-phase0-survival`，并完成 Day 3 规则版 ReAct 状态机。账号切换或 Day 4 新会话时，项目连续性由 Git 仓库、`AGENTS.md` 和 `docs` 交接文档保证，不由 Codex 账号记忆保证。
