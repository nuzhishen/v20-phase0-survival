...
| Sparse BM25 Only | 96.67% | 100.00% | 100.00% | 100.00% | 0.9833 | 94.12% | 0.11 ms | 3.33% |
| Hybrid alpha=0.2 | 96.67% | 100.00% | 100.00% | 100.00% | 0.9833 | 95.61% | 0.66 ms | 3.33% |
| Hybrid alpha=0.4 | 96.67% | 100.00% | 100.00% | 100.00% | 0.9833 | 95.98% | 0.65 ms | 0.00% |
...
| Hybrid alpha=0.8 | 86.67% | 96.67% | 100.00% | 96.67% | 0.9194 | 95.59% | 0.65 ms | 0.00% |
| Hybrid RRF | 83.33% | 100.00% | 100.00% | 100.00% | 0.9167 | 95.14% | 0.65 ms | 0.00% |
| Best Hybrid + MockReranker (Hybrid alpha=0.6) | 100.00% | 100.00% | 100.00% | 100.00% | 1.0000 | 92.77% | 3.65 ms | 0.00% |
...
我没有拍脑袋固定权重，而是在 30 条 TMS/OTT/养老 Query 上跑了 alpha=0.2,0.4,0.5,0.6,0.8 和 RRF 的对比实验，并记录退化 Query。最终最优配置是 Best Hybrid + MockReranker (Hybrid alpha=0.6)，Recall@3 从 90.00% 变为 100.00%，MRR 从 0.8678 变为 1.0000，平均延迟变化 +3.17 ms。
